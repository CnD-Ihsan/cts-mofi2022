...
class ReturnOrder extends StatefulWidget {
  ...
  const ReturnOrder({Key? key, required this.woId, required this.soId, required this.refresh})
      : super(key: key);
            ...
            children: [
              ...
              DropdownButton<String>(
                ...
                items: const [
                  ...
                  DropdownMenuItem(
                      value: 'Technical Issues', child: Text('Technical Issues')),
                                      ...
                                      body: PhotoViewGallery.builder(
                                          ...
                                          builder: (context, index) {
                                            return PhotoViewGalleryPageOptions(
                                              imageProvider: FileImage(File(listImage[index]!.path)),
                                            );
                                          }),
                                    )
                                  ),
              ...
              Center(
                child: ElevatedButton(
                  onPressed: () async {
                    ...
                    response = await WorkOrderApi.returnOrder(widget.woId, widget.soId, returnType, remarks, listImage);
                    if(mounted){}
                    if(response){
                      Navigator.push(
                        context,
